    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor.fetchall():
                ...
                list.append(Contact(id=str(id), firstname=firstname, lastname=lastname, address=address, email=email, email2=email2, email3=email3, telhome=home, telmobile=mobile, telwork=work, home2=phone2))
        finally:
            cursor.close()
        return list
